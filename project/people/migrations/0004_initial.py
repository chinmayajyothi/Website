...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PeoplePage'
        db.create_table(u'people_peoplepage', (
            (u'page_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['pages.Page'], unique=True, primary_key=True)),
            ('content', self.gf('mezzanine.core.fields.RichTextField')()),
        ))
        db.send_create_signal(u'people', ['PeoplePage'])

        # Adding model 'Person'
        db.create_table(u'people_person', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('_order', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='people', to=orm['people.PeoplePage'])),
        ...
        # Adding model 'Person2'
        db.create_table(u'people_person2', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('_order', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='people2', to=orm['people.PeoplePage'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('position', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('email', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('file', self.gf('mezzanine.core.fields.FileField')(max_length=200)),
        ...
        db.send_create_signal(u'people', ['Person2'])


    def backwards(self, orm):
        # Deleting model 'PeoplePage'
        db.delete_table(u'people_peoplepage')

        # Deleting model 'Person'
        db.delete_table(u'people_person')

        # Deleting model 'Person2'
        db.delete_table(u'people_person2')
    ...
    models = {
        ...
        u'people.person2': {
            'Meta': {'ordering': "(u'_order',)", 'object_name': 'Person2'},
            '_order': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'bio': ('mezzanine.core.fields.RichTextField', [], {'blank': 'True'}),
            'email': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'file': ('mezzanine.core.fields.FileField', [], {'max_length': '200'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'page': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'people2'", 'to': u"orm['people.PeoplePage']"}),
            'position': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'})
        },
        u'sites.site': {
