...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PeoplePage.page_ptr'
        ...
        # Adding field 'PeoplePage.title_color'
        db.add_column(u'people_peoplepage', 'title_color',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'PeoplePage.font_awesome_icon'
        db.add_column(u'people_peoplepage', 'font_awesome_icon',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)

        # Adding field 'PeoplePage.navbar_title'
        db.add_column(u'people_peoplepage', 'navbar_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'PeoplePage.catalystpage_ptr'
        raise RuntimeError("Cannot reverse this migration. 'PeoplePage.catalystpage_ptr' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'PeoplePage.catalystpage_ptr'
        ...
        # Deleting field 'PeoplePage.title_color'
        db.delete_column(u'people_peoplepage', 'title_color')

        # Deleting field 'PeoplePage.font_awesome_icon'
        db.delete_column(u'people_peoplepage', 'font_awesome_icon')

        # Deleting field 'PeoplePage.navbar_title'
        db.delete_column(u'people_peoplepage', 'navbar_title')
