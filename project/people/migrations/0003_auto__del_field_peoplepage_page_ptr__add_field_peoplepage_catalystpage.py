...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'people_peoplepage', u'catalystpage_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=datetime.datetime(2014, 6, 21, 0, 0), to=orm['custom.CatalystPage'], unique=True, primary_key=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'people_peoplepage', u'page_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=datetime.datetime(2014, 6, 21, 0, 0), to=orm['pages.Page'], unique=True, primary_key=True),
                      keep_default=False)
