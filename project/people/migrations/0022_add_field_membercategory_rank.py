...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MemberCategory.rank'
        db.add_column(u'people_membercategory', 'rank',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MemberCategory.rank'
        db.delete_column(u'people_membercategory', 'rank')
