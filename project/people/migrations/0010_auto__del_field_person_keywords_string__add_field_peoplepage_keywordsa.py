...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Person.keywords_string'
        db.delete_column(u'people_person', u'keywords_string')

        # Adding field 'PeoplePage.keywordsa_string'
        db.add_column(u'people_peoplepage', u'keywordsa_string',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Person.keywords_string'
        db.add_column(u'people_person', u'keywords_string',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Deleting field 'PeoplePage.keywordsa_string'
        db.delete_column(u'people_peoplepage', u'keywordsa_string')
    ...
    models = {
        ...
        u'people.peoplepage': {
            ...
            u'keywordsa_string': ('django.db.models.fields.CharField', [], {'max_length': '500', 'blank': 'True'}),
