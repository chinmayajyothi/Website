...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MemberCategory.heading_bar_color'
        db.add_column(u'people_membercategory', 'heading_bar_color',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MemberCategory.heading_bar_color'
        db.delete_column(u'people_membercategory', 'heading_bar_color')
