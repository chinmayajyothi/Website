...
STATIC_ROOT = "/home/skatukojwala/catalystcms/project/static/"
...
FABRIC = {
     "SSH_USER": "skatukojwala", # SSH username for host deploying to
     "HOSTS": ALLOWED_HOSTS[:1], # List of hosts to deploy to (eg, first host)
     "DOMAINS": ALLOWED_HOSTS, # Domains for public site
     "REPO_URL": "https://github.com/EdwardLiang/site-django-mezzanine.git", # Project's repo URL
     "VIRTUALENV_HOME":  "/home/skatukojwala", # Absolute remote path for virtualenvs
     "PROJECT_NAME": "chinmayajyoti", # Unique identifier for project
