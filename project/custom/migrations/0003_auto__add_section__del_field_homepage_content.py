...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'custom_section', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('_order', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sections', to=orm['custom.CatalystPage'])),
        ...
        db.send_create_signal(u'custom', ['Section'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'custom_section')

        # Adding field 'HomePage.content'
        db.add_column(u'custom_homepage', 'content',
                      self.gf('mezzanine.core.fields.RichTextField')(default=datetime.datetime(2014, 6, 21, 0, 0)),
                      keep_default=False)
