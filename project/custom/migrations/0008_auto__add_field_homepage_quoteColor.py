...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HomePage.quoteColor'
        db.add_column(u'custom_homepage', 'quoteColor',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HomePage.quoteColor'
        db.delete_column(u'custom_homepage', 'quoteColor')
