...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HomePage.quoteAttr'
        db.add_column(u'custom_homepage', 'quoteAttr',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'HomePage.quoteAttr'
        db.delete_column(u'custom_homepage', 'quoteAttr')
    ...
    models = {
        ...
        u'custom.homepage': {
            ...
            'quoteAttr': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        u'custom.section': {
