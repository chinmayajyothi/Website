...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ChapterPage.aboutText'
        db.alter_column(u'localchapters_chapterpage', 'aboutText', self.gf('django.db.models.fields.TextField')())

        # Changing field 'ChapterPage.eventsText'
        db.alter_column(u'localchapters_chapterpage', 'eventsText', self.gf('django.db.models.fields.TextField')())

        # Changing field 'ChapterPage.contactText'
        db.alter_column(u'localchapters_chapterpage', 'contactText', self.gf('django.db.models.fields.TextField')())

        # Changing field 'ChapterPage.handsonText'
        db.alter_column(u'localchapters_chapterpage', 'handsonText', self.gf('django.db.models.fields.TextField')())

        # Changing field 'ChapterPage.showsText'
        db.alter_column(u'localchapters_chapterpage', 'showsText', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'ChapterPage.aboutText'
        db.alter_column(u'localchapters_chapterpage', 'aboutText', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'ChapterPage.eventsText'
        db.alter_column(u'localchapters_chapterpage', 'eventsText', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'ChapterPage.contactText'
        db.alter_column(u'localchapters_chapterpage', 'contactText', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'ChapterPage.handsonText'
        db.alter_column(u'localchapters_chapterpage', 'handsonText', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'ChapterPage.showsText'
        db.alter_column(u'localchapters_chapterpage', 'showsText', self.gf('django.db.models.fields.CharField')(max_length=100))
