...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ChapterPictureCategory.page'
        db.add_column(u'localchapters_chapterpicturecategory', 'page',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='Chapter Picture Categories', null=True, to=orm['localchapters.ChapterPage']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ChapterPictureCategory.page'
        db.delete_column(u'localchapters_chapterpicturecategory', 'page_id')
    ...
    models = {
        ...
        u'localchapters.chapterpicturecategory': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'Chapter Picture Categories'", 'null': 'True', 'to': u"orm['localchapters.ChapterPage']"}),
